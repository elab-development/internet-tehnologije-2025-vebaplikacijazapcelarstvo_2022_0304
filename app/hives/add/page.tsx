...
export default function AddHivePage() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      if (formData.brPcela <= 0)
        throw new Error("Broj pčela mora biti veći od 0.");
      if (formData.brRamova <= 0 || formData.brRamova > 30)
  ...
  return (
    <div className="max-w-2xl mx-auto flex gap-4 items-start">
      <Link
        href="/hives"
        className="mt-2 flex flex-col items-center gap-2 text-amber-600 dark:text-amber-400 hover:text-amber-700 transition-colors font-medium bg-white dark:bg-gray-800 border-2 border-amber-200 dark:border-amber-900 rounded-2xl p-4 shadow-md hover:shadow-lg"
      >
        <Image
        ...
        <div className="px-8 pb-8 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setFormData((prev) => ({ ...prev, naziv: e.target.value }))
              }
            ...
            <div className="flex items-center border border-gray-300 dark:border-gray-600 rounded-xl overflow-hidden">
              <button
                ...
                onClick={() =>
                  setFormData((prev) => ({
                    ...prev,
                    brPcela: Math.max(0, prev.brPcela - 500),
                  }))
                }
            ...
            <div className="grid grid-cols-3 gap-2">
              {[
                ...
                },
                {
                  value: "JAKA",
                  label: "Jaka",
                  active: "bg-green-500 border-green-500 text-white shadow-md",
                  inactive:
                ...
                <button
                  ...
                  type="button"
                  onClick={() =>
                    setFormData((prev) => ({ ...prev, jacina: opt.value }))
                  }
            ...
            <div className="flex items-center border border-gray-300 dark:border-gray-600 rounded-xl overflow-hidden">
              <button
                ...
                onClick={() =>
                  setFormData((prev) => ({
                    ...prev,
                    brRamova: Math.max(1, prev.brRamova - 1),
                  }))
                }
                className="w-14 h-14 bg-gray-100 dark:bg-gray-600 hover:bg-gray-200 dark:hover:bg-gray-500 text-gray-800 dark:text-white text-2xl font-bold transition-colors flex items-center justify-center"
              >
              ...
              <button
                ...
                onClick={() =>
                  setFormData((prev) => ({
                    ...prev,
                    brRamova: Math.min(30, prev.brRamova + 1),
                  }))
                }
                className="w-14 h-14 bg-gray-100 dark:bg-gray-600 hover:bg-gray-200 dark:hover:bg-gray-500 text-gray-800 dark:text-white text-2xl font-bold transition-colors flex items-center justify-center"
              >
          ...
          <div>
            ...
            {latitude && (
              <p className="text-xs text-green-600 dark:text-green-400 mt-1">
                ✅ Lokacija odabrana: {latitude.toFixed(4)},{" "}
                {longitude?.toFixed(4)}
              </p>
            )}
          </div>
